...
def save_to_db(unique_id, resume_text=None, questions=None, db_path='adzat_db.json'):
...
def get_next_question():
    with open("adzat_db.json", "r") as file:
        data = json.load(file)
    ...
    with open("adzat_db.json", "w") as file:
...
def update_user_response():
    ...
    with open("adzat_db.json", "r") as f:
        data = json.load(f)
    ...
    with open('adzat_db.json', "w") as f:
